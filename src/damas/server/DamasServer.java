...
public class DamasServer {
    private static final int SERVER_PORT = 8840;

    private static final int HTTP_PORT = 8841;

    private static final int JMX_PORT = 8842;

    private static final int RMI_PORT = 8843;

    private static Logger log = LoggerFactory.getLogger(DamasServer.class);
    ...
    public static void main(String[] args) throws Throwable {
        ...
        DamasSessionHandler server = new DamasSessionHandler();
        ...
        ObjectName bean = new ObjectName("DamasServer:type=DamasServiceManager");
